    ...
    <head>
        ...
        <script type="text/javascript">
          ...
          function redirectInscription() {
            window.location.href="Minscrire.php";
          }
      ...
      <div id="containerMega" class="container-fluid">
        ...
        <div class="login-box">
          ...
          <form action="verificationConnexion.php" method="post">
            ...
            <button type="button" style="display: flex; margin-left: auto; margin-right: auto; width: max-content;" onClick="redirectInscription();">
              <span></span>
              <span></span>
              <span></span>
              <span></span>
