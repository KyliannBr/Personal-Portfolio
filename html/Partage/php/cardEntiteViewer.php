<div class="wrapperCards">
	<div class="container" onclick=";recuperationDataModification('<?php echo($arrayId[$i]); ?>','<?php echo($arrayNom[$i]);?>','<?php echo($arrayDesc[$i]);?>','<?php echo($arrayPrix[$i]);?>','<?php echo($arrayLieu[$i]);?>','<?php echo($arrayImage[$i]); ?>','<?php echo($arrayImage2[$i]); ?>','<?php echo($arrayImage3[$i]); ?>','<?php echo($arrayImage4[$i]); ?>','<?php echo($arrayImage5[$i]); ?>','<?php echo($arrayImage6[$i]); ?>','<?php echo($arrayProprietaire[$i]); ?>');redirectModif();">
		<div class="front" style="background-image: url(uploads/<?php echo $arrayImage[$i]; ?>)">
			<div class="inner">
