...
<?php 
        ...
        $sql3 = "INSERT INTO `compte`(`username`, `entiteAjoutee`, `entiteeLouee`, `entiteentraindelouer`) VALUES ('$proprietaireAjout','$idAjout',' ',' ');";

        $phrase = utf8_encode("Votre annonce a bien été enregistrée.");
