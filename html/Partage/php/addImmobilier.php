...
<div class="topnav" id="Topnav" style="display: flex; justify-content: center;">
        ...
        <a href="addMobilier.php" id="TopnavAjouter">MOBILIER</a>
</div>

<div class="middle">
    <h1 style="color: white">Immobillier</h1>
    <div class="wrapper">
            <form method="POST" action="verificationAjout.php" autocomplete="on" enctype="multipart/form-data">

                <input type="text" id="type" name="type" width="0vw" height="0vh" value="immobilier" style="display: none;">
    ...
    <br><br>
                <label for="fileToUpload" class="label-file">Importer une image</label>
